...
const t0 = Date.now();
await page.goto("http://127.0.0.1:3077/dashboard/kurir/cod-risk", { waitUntil: "load" });
...
await page.goto("http://127.0.0.1:3077/dashboard/hub/forecast", { waitUntil: "load" });
...
await page.goto("http://127.0.0.1:3077/dashboard/data/overview", { waitUntil: "load" }); await page.waitForTimeout(800);
...
await page.goto("http://127.0.0.1:3077/dashboard/hub/dashboard", { waitUntil: "load" }); await page.waitForTimeout(1500);
