  ...
  {:else if loaded}
    ...
    <div class="rounded-2xl border bg-card p-5">
      ...
      <ul class="space-y-2 text-sm text-muted-foreground">
        <li class="flex gap-2"><span class="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-primary"></span><span><span class="font-medium text-foreground">Alamat tidak terstandarisasi</span> → Address Intelligence + geotag wajib saat checkout.</span></li>
        <li class="flex gap-2"><span class="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-primary"></span><span><span class="font-medium text-foreground">Routing error (alamat ambigu)</span> → fuzzy matching + 3 kandidat koordinat terskor.</span></li>
        <li class="flex gap-2"><span class="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-primary"></span><span><span class="font-medium text-foreground">Delivery failure (geotag tidak akurat)</span> → konfirmasi slot + ETA presisi.</span></li>
      </ul>
    </div>
