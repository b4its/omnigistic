...
<div class="space-y-6">
  ...
  {#if myOrders.length === 0}
    <div class="rounded-2xl border border-dashed border-border bg-card p-12 text-center">
      ...
      <a href={resolveHref("/dashboard/seller/products")} class="mt-5 inline-flex items-center gap-2 rounded-full bg-primary px-5 py-2.5 text-sm font-semibold text-primary-foreground transition-transform hover:-translate-y-px">
