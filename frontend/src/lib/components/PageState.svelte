...
{#if error}
  <div class="rounded-2xl border border-destructive/40 bg-destructive/5 p-6 text-center">
    <span class="mx-auto flex h-12 w-12 items-center justify-center rounded-2xl border border-destructive/50 bg-destructive/10 text-destructive-foreground"><Icon name="warn" cls="h-6 w-6" /></span>
